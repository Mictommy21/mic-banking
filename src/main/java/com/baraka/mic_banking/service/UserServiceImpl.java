...
import com.baraka.mic_banking.config.JwtTokenProvider;
import com.baraka.mic_banking.dto.*;
import com.baraka.mic_banking.entity.Role;
import com.baraka.mic_banking.entity.User;
import com.baraka.mic_banking.repository.UserRepository;
import com.baraka.mic_banking.utils.AccountUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public BankResponse debitAccount(CreditDebitRequest request) {
        ...
        if (userToDebit.getAccountBalance()
    ...
    public BankResponse transfer(TransferRequest request) {
        ...
        if (request.getAmount()
                .compareTo(sourceAccountUser.getAccountBalance()) > 0) {
